...
export default function Sidebar({ activeTab, onTabChange, onSignOut }: SidebarProps) {
  return (
    <aside className="hidden md:block fixed left-0 top-0 h-full bg-gray-900 text-white w-64 z-30">
      <div className="p-5 border-b border-gray-800">
        <h1 className="text-xl font-bold text-orange-500">Grill</h1>
      ...
      <nav className="mt-6">
        ...
        <button
          onClick={onSignOut}
          className="w-full flex items-center px-5 py-3 mt-6 text-red-400 hover:bg-gray-800 transition-colors"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
